...
//                      Collectors.toMap(Meal::getDate, Meal::getCalories, Integer::sum)
    ...
    public static List<MealWithExceed> createListWithExceed(List<Meal> meals, int caloriesPerDay){
        List<MealWithExceed> mealWithExceedList = meals.stream()
                .map(meal -> new MealWithExceed(meal.getDateTime(), meal.getDescription(), meal.getCalories(), meal.getCalories() < caloriesPerDay))
                .collect(toList());
