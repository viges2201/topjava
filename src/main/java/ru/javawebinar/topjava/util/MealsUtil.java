...
public class MealsUtil {
    public static final List<Meal> MEALS = Arrays.asList(
            ...
            new Meal(LocalDateTime.of(2015, Month.MAY, 30, 13, 0), 1,"Обед", 1000),
            new Meal(LocalDateTime.of(2015, Month.MAY, 30, 20, 0), 1,"Ужин", 500),
            new Meal(LocalDateTime.of(2015, Month.MAY, 31, 10, 0),2, "Завтрак", 1000),
            new Meal(LocalDateTime.of(2015, Month.MAY, 31, 13, 0),2, "Обед", 500),
            new Meal(LocalDateTime.of(2015, Month.MAY, 31, 20, 0),2, "Ужин", 510)
    );
